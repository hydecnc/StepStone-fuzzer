...
var (
	...
	flagSandbox    = flag.String("sandbox", "", "sandbox to use (none, setuid, namespace, android, bypass)")
...
func main() {
	...
	opts := csource.Options{
		...
		Nvidia:        features["nvidia"].Enabled,
		OpenCL:        features["opencl"].Enabled,
		Vulkan:        features["vulkan"].Enabled,
	...
	bin, err := csource.Build(target, p.Calls, src)
	if err != nil {

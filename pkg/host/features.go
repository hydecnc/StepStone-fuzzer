...
func Check(target *prog.Target) (*Features, error) {
	...
	res := &Features{
		...
		FeatureNvidia:           {Name: "nvidia driver", Reason: unsupported},
		FeatureOpenCL:           {Name: "OpenCL setup", Reason: unsupported},
		FeatureVulkan:           {Name: "Vulkan setup", Reason: unsupported},
	}

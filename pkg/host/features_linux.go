...
func init() {
	...
	checkFeature[FeatureNetDevices] = checkNetDev
	...
	checkFeature[FeatureNvidia] = checkNvidia
	checkFeature[FeatureOpenCL] = checkOpenCL
	checkFeature[FeatureVulkan] = checkVulkan
}
...
func checkFault() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_FAULT"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkLeak() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_LEAK"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkSandboxAndroid() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_ANDROID_SANDBOX"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkNetInjection() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_NET_INJECTION"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkUSBEmulation() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_USB"); err == nil {
		return "disabled"
	}
	return ""
}

func checkNetDev() string {
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_NETDEV"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkNvidia() string {
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_NVIDIA"); err == nil {
		return "disabled"
	}
	if err := osutil.IsAccessible("/usr/local/cuda"); err != nil {
		return "disabled"
	}
	return ""
}

func checkOpenCL() string {
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_OPENCL"); err == nil {
		return "disabled"
	}
	return ""
}

func checkVulkan() string {
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_VULKAN"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkVhciInjection() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_VHCI"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkDebugFS() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_DEBUGFS"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkKCSAN() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_KCSAN"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkDevlinkPCI() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_DEVLINK"); err == nil {
		return "disabled"
	}
	return ""
}
...
func checkNicVF() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_NICVF"); err == nil {
		return "disabled"
	}
...
func checkWifiEmulation() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_WIFI"); err == nil {
		return "disabled"
	}
...
func check802154Emulation() string {
	...
	if err := osutil.IsAccessible("/root/.syzkaller_features/DISABLE_802154"); err == nil {
		return "disabled"
	}
	return ""
}

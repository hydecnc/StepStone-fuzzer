...
func (ctx *linux) Symbolize(rep *Report) error {
	...
	// Dont need maintainer info for Nvidia GPUs
	/*if rep.GuiltyFile != "" {
...
var linuxOopses = append([]*oops{
	...
	// 			report: compile("Assertion failed: (.*)"),
	// 			fmt:    "Nvidia assertion failed: %[1]v",
	// 		},
	// 	},
	// 	[]*regexp.Regexp{},
	// 	crash.UnknownType,
	...
	// 	[]oopsFormat{
	// 		{
	// 			title:  compile("Assert failed"),
	// 			report: compile("Assert failed: (.*)"),
	// 			fmt:    "Nvidia assert failed: %[1]v",
	// 		},
	// 	},
	// 	[]*regexp.Regexp{},
	// 	crash.UnknownType,

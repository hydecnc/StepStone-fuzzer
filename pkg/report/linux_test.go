...
func TestNvidiaCrash(t *testing.T) {
	...
	const log = `
[  913.908770][T13506] NVRM: nvAssertFailedNoLog: Assertion failed: 0 @ kernel_ctxshare.c:395
[  913.909858][T13506] CPU: 7 PID: 13506 Comm: syz-executor Tainted: G           OE      6.8.0-dirty #44
[  913.910408][T13506] Hardware name: QEMU Standard PC (i440FX + PIIX, 1996), BIOS 1.16.2-debian-1.16.2-1 04/01/2014
	`

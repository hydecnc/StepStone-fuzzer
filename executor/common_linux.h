...
#if SYZ_EXECUTOR
const int kExtraCoverSize = 2 << 20;
struct cover_t;
...
static int event_timedwait(event_t* ev, uint64 timeout)
{
    ...
    SYZ_SANDBOX_SETUID || SYZ_SANDBOX_NAMESPACE || SYZ_SANDBOX_ANDROID || SYZ_SANDBOX_BYPASS || \
...
#if SYZ_EXECUTOR || SYZ_SANDBOX_NONE || SYZ_SANDBOX_SETUID || SYZ_SANDBOX_NAMESPACE || SYZ_SANDBOX_ANDROID || SYZ_SANDBOX_BYPASS
#include <fcntl.h>
#include <sched.h>
#include <sys/stat.h>
#include <sys/types.h>
...
#if SYZ_EXECUTOR || (SYZ_CGROUPS && (SYZ_SANDBOX_NONE || SYZ_SANDBOX_SETUID || SYZ_SANDBOX_NAMESPACE || SYZ_SANDBOX_ANDROID || SYZ_SANDBOX_BYPASS))
#include <fcntl.h>
#include <string.h>
#include <sys/mount.h>
#include <sys/stat.h>
...
#if SYZ_EXECUTOR || SYZ_OPENCL
#include "syz_opencl.h"
#endif

#if SYZ_EXECUTOR || SYZ_VULKAN
#include "syz_vulkan.h"
#endif

#if SYZ_EXECUTOR || SYZ_SANDBOX_BYPASS
static int do_sandbox_bypass(void)
{
	debug("[GPU Fuzzing] ========> do_sandbox_bypass\n");
	loop();
	doexit(1);
}
#endif
